...
class PostTags extends amplify_core.Model {
  ...
  static final amplify_core.QueryModelIdentifier<PostTagsModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<PostTagsModelIdentifier>();
 ...
 */
class PostTagsModelIdentifier implements amplify_core.ModelIdentifier<PostTags> {
  final String id;
